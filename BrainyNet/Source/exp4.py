"""
Experiment 4: Network Width Variation
Variations: 100, 250, 400 neurons (Depth = 10)
...
if __name__ == "__main__": 
    results_dir = "../Results/Experiment4_Width"
    if not os.path.exists(results_dir): os.makedirs(results_dir)
    
    width_variations = [100, 250, 400]
    fixed_depth = 10
    ...
    for width in width_variations:
        print(f"\n======== STARTING RUN: Width = {width} neurons ========\n")
        tf.reset_default_graph()
        
        layers = [4] + fixed_depth * [width] + [5]
        ...
        vtk_dir = f"{results_dir}/vtk_width_{width}"
        ...
        scipy.io.savemat(f"{results_dir}/results_width_{width}.mat",
